...
void env_set_nice(struct Env* e, int nice_value)
{
	...
	if (e->env_status != ENV_NEW){
		...
		fixed_point_t term2 = fix_unscale(e->recent_cpu, 4);
		fixed_point_t term3 = fix_int(e->nice * 2);
...
int env_get_recent_cpu(struct Env* e)
{
	...
	fixed_point_t x = fix_scale(e->recent_cpu, 100);
	return fix_round(x);
}
int get_load_average()
{
	...
	fixed_point_t x = fix_scale(load_avg, 100);
	return fix_round(x);
}
/********* for BSD Priority Scheduler *************/
//==================================================================================//
